...
def delightApply_HyperParam(configfilename, hyperParam_name="", hyperParam_list=[]):
    """
    ...
    if sensitivity and hyperParam_name != "ellSigmaPrior":
        ...
        for chunk in range(numChunks):
            ...
            print("{} value does not affect GP.".format(hyperParam_name))
            print("Creation of GP with values from config file.")
            ...
            if sensitivity and hyperParam_name == "ellSigmaPrior":
                ...
                for hyperParam in hyperParam_list:
                    allEv = []
                    allTargetZ = []
                    print("Computation of likelihood and evidences for {} = {}".format(hyperParam_name, hyperParam))
                    targetDataIter = getDataFromFile(params, firstLine, lastLine,prefix="target_", getXY=False, CV=False)
...
if __name__ == "__main__":  # pragma: no cover
    ...
    delightApply_HyperParam(sys.argv[1])
